        ...
        <div align="center" >
            ...
            <form id="lead-form" action="<?=SITE_URL?>/save-lead" method="post" >
                <table width="340" cellpadding="7"  cellspacing="7">
                    <tr>
                        <td colspan="2">
                            <input type="text" class="form-control lead_name"  placeholder="Full Name*"  name="name" id="name"  maxlength="40">
                            <small  class="txt-red valid" id='msg-name'>Please enter your name.</small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <input type="email" class="form-control lead_email"  placeholder="Enter email*"  name="email" id="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$">
                    ...
                    <tr>
                        ...
                        <td style="padding-bottom:0;">
                            <input type="text" pattern="\d*" minlength="8" maxlength="10" class="form-control lead_mobile"  placeholder="Mobile Number*" id="mobile" name="mobile" >
                        </td>
                    </tr>
                    <tr>
