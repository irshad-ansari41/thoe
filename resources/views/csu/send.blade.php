...
$slogourl = 'https://azizidevelopments.com/assets/images/cusicon/logos/';
$progressurl = 'https://azizidevelopments.com/assets/images/cusicon/';
...
<html lang="en">
    ...
    <body style="background:#172c5b; background-color:#172c5b; width:595px; margin:0 auto; font-family:Helvetica; font-size:13px;" bgcolor="#172c5b">
        ...
        <table width="595" border="0" align="center" style="background:#fff; background-color:#fff;" bgcolor="#ff"  
...
يسرنا تقديم آخر المستجدات عن تقدم سير الأعمال في منزلك من عزيزي. تتبنى عزيزي للتطوير العقاري خطة بناء إستراتيجية وتضمن في الوقت المحدد تقديم آخر أخبار مشاريعها قيد الإنشاء في دبي، لإبقائك على اطلاع دائم بوتيرة سير الأعمال.
            ...
            <tr>
                <?php if (!empty($CSUpdate['fMOBILIZATION']) == 'fMOBILIZATION'): ?>
                    <td align="center" width="149">

                        <img src="<?= !empty($CSUpdate['mobilization_percentage']) ? $progressurl . $CSUpdate['mobilization_percentage'] : $progressurl . '0' ?>.png" width="90"/>
                ...
                <?php if (!empty($CSUpdate['GROUND']) == 'GROUND'): ?>
                    <td align="center">
                        ...
                        <img src="<?= !empty($CSUpdate['structure_percentage']) ? $progressurl . $CSUpdate['structure_percentage'] : $progressurl . '0' ?>.png" width="90"/>
                ...
                <?php if (!empty($CSUpdate['STRUCTURE']) == 'STRUCTURE'): ?>
                    <td align="center" style="padding:0px 0px 0px 25px;">
                        ...
                        <img src="<?= !empty($CSUpdate['mep_percentage']) ? $progressurl . $CSUpdate['mep_percentage'] : $progressurl . '0' ?>.png" width="90"/>
                ...
                <?php if (!empty($CSUpdate['FINISHING']) == 'SERVICES & FINISHING'): ?>
                    <td align="center" width="174">
                        ...
                        <img src="<?= !empty($CSUpdate['finishes_percentage']) ? $progressurl . $CSUpdate['finishes_percentage'] : $progressurl . '0' ?>.png" width="90"/>
            ...
            <tr>
                <td colspan="4"> 
                    ...
                    width="595px" /-->
                    <img src="https://azizidevelopments.com/assets/images/properties/{{$CSUpdate['gallery_location']}}/{{$CSUpdate['bpgallery_location']}}/{{ $CSUpdate['header_image'] }}" 
                         height="331" width="595" style="height:331px; width:595px; max-width: 595px; min-width:595px;" />
