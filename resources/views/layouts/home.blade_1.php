...
<html lang="{{$hreflang}}">
    <head>
        ...
        <link rel="icon" type="image/x-icon"  sizes="192x192"  href="<?= asset('frontend-assets/favicon') ?>/android-icon-192x192.png">
        <link rel="icon" type="image/x-icon"  sizes="32x32" href="<?= asset('frontend-assets/favicon') ?>/favicon-32x32.png">
        <link rel="icon" type="image/x-icon"  sizes="96x96" href="<?= asset('frontend-assets/favicon') ?>/favicon-96x96.png">
        <link rel="icon" type="image/x-icon"  sizes="16x16" href="<?= asset('frontend-assets/favicon') ?>/favicon-16x16.png">
        ...
        <?php if ($locale == 'ar') { ?>
            <link rel="stylesheet" href="<?= asset('frontend-assets/ar-font/stylesheet.css') ?>" type="text/css">
    ...
    <body class="<?= $locale == 'ar' ? 'txtRight' : 'txtLeft' ?>">
                    ...
                    <div class="container">
                        <div class="row">
                            <?php if ($locale == 'ar') { ?>
                                ...
                                <img class="pull-left bank-logo" alt="master-card" src="" data-src="<?= asset('frontend-assets/img/') ?>/master-card.png" >
                                <img class="pull-left bank-logo" alt="visa" src="" data-src="<?= asset('frontend-assets/img/') ?>/visa.png">
                                <span class="pull-left"><?= trans('words.We accept') ?>:</span>
                            <?php } else { ?>
                                <a target="blank"><?= trans('words.copyright_string') ?></a> 
                                <img class="pull-right bank-logo" alt="master-card" src="" data-src="<?= asset('frontend-assets/img/') ?>/master-card.png">
                                <img class="pull-right bank-logo" alt="visa" src="" data-src="<?= asset('frontend-assets/img/') ?>/visa.png" >
            ...
            <div class="modal-dialog" style="max-width:350px">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close txt-white" data-dismiss="modal" style="<?= $locale == 'ar' ? 'left: 10px;' : 'right: 10px;' ?>">&times;</button>
        ...
        <script  src="<?= asset('frontend-assets/js/') ?>/jquery-bootstrap-carousel-cmp.js"></script>
        ...
        <script>
            ...
            if (campaign !== '' && campaign !== null) {
                ...
                sessionStorage.setItem("utm_campaign", 'Home Page');
            }
...
//            });
            ...
            /*$(function(){
                ...
                if(screenwidth <= '800'){ redirectpage = '<?= url('mobile-view') ?>';}
                else if(screenwidth >= '801'){ redirectpage = '<?= url('/') ?>';}
