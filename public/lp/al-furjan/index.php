    ...
    <body>
                        ...
                        <div class=row>
                            <div class=col-md-8>
                                <div class=slider-text>
                                    ...
                                    <br/>
                                    <p>
                                        Pay 10% and move in to your own home.<br>
                                        Pay 75% on handover and 15% after handover.<br>
                                    </p>
                ...
                <div class="gallery wrapper clearfix">
                    <div class=container>
                        <div class="title text-center wow fadeIn">
                            <h2><span class=bold>Al Furjan</span> Completed Projects</h2>
                        </div>

                        <section id=grid class="grid clearfix mobile-hide">
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href=images/gallery/lg/samia-large.jpg data-lightbox="Canal views are back" data-title="Candace Acacia by Azizi">
                                <figure>
                            ...
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href=images/gallery/lg/star-large.jpg data-lightbox="Canal views are back" data-title="Candace Aster by Azizi">
                                <figure>
                            ...
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href=images/gallery/lg/farishta-large.jpg data-lightbox="Canal views are back" data-title="Azizi Daisy">
                                <figure>
                            ...
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href=images/gallery/lg/plaza-large.jpg data-lightbox="Canal views are back" data-title="Azizi Feirouz">
                                <figure>
                            ...
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href=images/gallery/lg/shaista-large.jpg data-lightbox="Canal views are back" data-title="Azizi Freesia">
                                <figure>
        ...
        <script>
            ...
            if (campaign !== '' && campaign !== null) {
                ...
                sessionStorage.setItem("utm_campaign", 'Al Furjan');
            }
