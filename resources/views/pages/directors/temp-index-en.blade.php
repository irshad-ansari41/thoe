    ...
    <div class="container">
        <div class="parallax-container valign-wrapper only-heading">
            ...
            <div class="col s12 center-align card tag-pro">
                <h1>Board of Directors<!--{{trans('words.Corporate Executives')}}--></h1>
            </div>
        </div>
        <div class="row m0">
            <div class="col s12 p0">
                <div class="col s12 p0">
                    <?= generate_breadcrumb([url("$locale") => trans('words.home'), '' => 'Board of Directors']) ?>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row rowgaps" >
                    ...
                    <div class="col s12 m12 l9 xl9 gaps" data-aos="fade-in" data-aos-once="true">
                        <div class="desig-person mt0">
                            ...
                            <i>CHAIRMAN, AZIZI DEVELOPMENTS <!--{{trans('words.Chairman, Azizi Group')}}--></i>
                        </div>
                    ...
                    <div class="col s12 m12 l6 xl6" style="margin:0 0 35px 0;">
                        <div class="row hover08">
                            ...
                            <div class="col s12 m12 l8 xl8 Sec-Team" data-aos="fade-out" data-aos-once="true">
                                <h5 class="person-name" style="margin:10px 0px;">{{ $team['name'] }}</h5>
                                
                                <h3 style="margin:0px 0px 15px 0px; font-size:11.5px; letter-spacing:1px; text-transform: uppercase; font-weight: bold;">{{ $team['designation'] }}</h3>
                                <p class="TPara">
                                    {{ $team['description_en'] }}
                                </p>
