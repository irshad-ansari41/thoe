                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-9">
								<?php
									$gs = ''; $hm =''; $ab =''; $tm =''; $sp =''; $pr =''; $pu =''; $cu =''; $ns =''; $es =''; $me =''; $cu =''; $ag =''; $ca =''; $bp =''; $us ='';
									if(!empty($modules))
									{
										if($modules->general_settings==1){$gs = 'checked';}
										if($modules->home==1){$hm = 'checked';}
										if($modules->about_us==1){$ab = 'checked';}
										if($modules->team==1){$tm = 'checked';}
										if($modules->static_pages==1){$sp = 'checked';}
										if($modules->properties==1){$pr = 'checked';}
										if($modules->property_units==1){$pu = 'checked';}
										if($modules->construction_updates==1){$cu = 'checked';}
										if($modules->news==1){$ns = 'checked';}
										if($modules->events==1){$es = 'checked';}
										if($modules->media==1){$me = 'checked';}
										if($modules->contact_us==1){$cu = 'checked';}
										if($modules->agents==1){$ag = 'checked';}
										if($modules->careers==1){$ca = 'checked';}
										if($modules->booking_payments==1){$bp = 'checked';}
										if($modules->users==1){$us = 'checked';}
									}
								?>
