...
<div class="wrapper">
    ...
    <div id="page-content_home">
        ...
        <div class="home_2">
            ...
            <div id='stick-form' class="mobiledevices" style="position:absolute; top:calc(100% - 140px); right:2%; z-index: 99999;">
            ...
            <div id="owl-demo-header" class="owl-carousel owl-theme carousel-full-width">
                ...
                <div class="item">
                    ...
                    <div class="bigSlide"  data-original="<?= asset("assets/images/home_banners/" . $slider->banner_image) ?>">
                    </div>

                    <div class="container Smsgbox">
                        <?php
                        $banner_Title = preg_replace('/\s+/', '', $slider->banner_title_en);
                        if (!empty(trim($banner_Title))) {
                            ?>
                            <div class="title col-lg-6  col-md-6 col-sm-8 col-xs-9">
                                <!--<h2 class="vsmall" style="margin-bottom:7px !important;"><b><?= $slider->banner_title_en ?></b></h2>-->
                                ...
                                <?php if ($slider->inquire_button_option == "1") { ?>
                                    <span class="ffs-bs mobileds"><a data-toggle="modal"  data-target="#lead-form-model" data-campaign="{{$banner_Title}}" class="btn btn-default btn-small pointer">
