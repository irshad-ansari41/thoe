...
<section class="az-section">
    ...
    <div class="container">
        <div class="parallax-container valign-wrapper">
            <div class="parallax">
                <img alt="banner" src="<?=SITE_URL?>/assets/images/banner/1512284846.jpg">
            </div>
        </div>
        <div class="row m0">
                ...
                <div class="row">
                        ...
                        <main class="cd-main-content">
                            <div class="cd-tab-filter-wrapper">
                                <div class="cd-tab-filter">
                                    <ul class="cd-filters">
                                        ...
                                        <li class="filter" data-filter=".<?= $Projects->gallery_location ?>">
                                            <a class="" href="#0" data-type="<?= $Projects->gallery_location ?>">
                                                <?= $Projects->title_en; ?>
                                            </a>
                                        </li>
                                        @endforeach
                            ...
                            <section class="cd-gallery" style="padding-bottom:0;">
                                <ul>
                                    ...
                                    <li class="mix <?= $Properties->project_location ?> col m3" style='height: 420px'>
                                        <div class="col s12 pro-holder">
                                            <div class="card col s12 p0">
                                                <img alt="<?= $Properties->property_title_en ?>" src="{{url('/assets/images/properties/'.$Properties->project_location.'/'.$Properties->propert_location.'/'.$Properties->holder_image)}}" class="responsive-img pro-image">
                                                <div class="col s12 title-holder center-align" >
                                                    <h5 style="font-size: 17px;text-transform: capitalize;font-weight: 600;text-align: center;"><?= $Properties->property_title_en ?></h5>
                                                    <a class="d-asset" style="cursor:pointer;text-align: center;" onclick="setassets({<?= $Properties->proid ?>">{{trans('words.Download Assets')}} <i class="icon ion-ios-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div id="tab-assets" class="col s12">
                        <div class="col s12 p0 book-now" style="margin: 35px 0px;">
                            <form method="post" name="getbrochers" action="{{url("$locale/downloaddata")}}" />
                            <div class="col s12">
                            ...
                            <div class="col s12 m4">
                                <div class="input-field col s12" style="padding-left: 0;" >
                                    <select name="agentdash_project" id="agentdash_project">
                                        ...
                                        <option value="{!! $allproperties->proid !!}">{!! $allproperties->property_title_en !!}</option>
                                        @endforeach
                                        @endif
                                    </select>
...
//console.log(data);
 ...
 sessionStorage.setItem("utm_source", 'Website');sessionStorage.setItem("utm_campaign", 'Others');</script>
