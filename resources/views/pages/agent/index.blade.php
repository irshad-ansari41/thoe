                    ...
                    <form method="post" action="{{route('agent-login')}}" name="login" autocomplete="off">
                        ...
                        <div class="col s12 m4">
                            <div class="input-field col s12" style="border: 1px solid #e4e4e4;border-radius: 2px;">
                                <div class="col s12">
                                    <input name="email" type="text" id="autocomplete-input" class="autocomplete" style="border-bottom: none;margin-bottom: 0;font-size: 15px;letter-spacing: 1px;font-weight: 100;height: 35px;" placeholder="{{trans('words.email_label')}}" autocomplete="off" required="">
                                </div>
                            </div>
                        </div>
