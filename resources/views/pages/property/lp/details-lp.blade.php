...
<div class="container">
    <div class="row">
        <div class="col s12 m8">
            ...
            <div class="col s12 p0" style="margin-top:50px;"></div>
            <!-- Description -->
            ...
            <?php if ($locale == 'en') { ?>
                                ...
                                if (!empty($galleries)) {
                                    ...
                                    foreach ($galleries as $gallery) {
                                        if ($gallery->image != "") {
                                            ?>
                                            <div class="sp-slide">
                                                <img alt="{{ trim($property->title_en) }}- Gallery <?php echo $k; ?>" class="sp-image" src="{{ url("/") }}/assets/blank.gif" 
                ...
                <div class="col s12 m4" style="margin-top:50px;"></div>    
                ...
                <div class="col s12 p0" style="margin-top: 3em;"></div>
...
//                });
                ...
                $('#vbrochureFile,#floorplanFile').click(function () {
                    ...
                    sessionStorage.setItem("utm_source", 'Website Download');
