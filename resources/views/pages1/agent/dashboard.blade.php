                ...
                <div class="row">
                        ...
                        <main class="cd-main-content">
                            <div class="cd-tab-filter-wrapper">
                                <div class="cd-tab-filter">
                                    <ul class="cd-filters">
                                        ...
                                        <li class="filter" data-filter=".{!! $agent['path'] !!}"><a class="" href="#0" data-type="{!! $agent['path'] !!}">{!! $agent['title_en'] or '' !!}</a></li>
                                        @endforeach
                                        @endif
                            ...
                            <section class="cd-gallery" style="padding-bottom:0;">
                                <ul>
                                    ...
                                    <li class="mix {!! $res['path'] !!} col m3 center-align" style='height: 420px'>
                                        <div class="col s12 pro-holder">
                                            <div class="card col s12 p0">
                                                <img alt="<?= $res['title_en'] ?>" src="<?= asset("assets/images/100-blank-img.jpg") ?>"  data-src="{{ $res['imagepath'] }}" class="responsive-img pro-image">
                                                <div class="col s12 title-holder">
                                                    <h5 style="font-size: 17px;text-transform: capitalize;font-weight: 600;">{!! $res['title_en'] !!}</h5>
                    ...
                    <div id="tab-assets" class="col s12">
                        <div class="col s12 p0 book-now" style="margin: 35px 0px;">
                            ...
                            <div class="col s12 m4">
                                <div class="input-field1 col s12" style="padding-left: 0;" >
                            ...
                            <div class="col s12 m4">
                                <div class="col s12 m4">
                                    ...
                                    <input type="submit" name="bdownload" id="bdownload" value="{{trans('words.Download Now')}}" class="inquire az-btn active p0" style="margin-top: 0;" />
                    ...
                    <div id="tab-commisions" class="col s12">
                        <div class="col s12 p0 book-now" style="margin: 35px 0px;">
                            ...
                            <div class="col s12 m4">
                                <div class="col s12 m4">
                                    <a class="inquire az-btn active p0" style="margin-top:0;">{{trans('words.Download Now')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
