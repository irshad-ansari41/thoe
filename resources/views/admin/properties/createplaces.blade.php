                ...
                <div class="panel panel-danger">
					...
					@for($i=1;$i<=count($near);$i++)	   
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($near){{ $near[$j]->title_ch }} @endif" name="title_ch[]"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($near){{ $near[$j]->title_hn }} @endif" name="title_hn[]"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($near){{ $near[$j]->title_ur }} @endif" name="title_ur[]"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="description_ch[]">@if($near){{ $near[$j]->description_ch }} @else {{ old('description_ch') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="description_hn[]">@if($near){{ $near[$j]->description_hn }} @else {{ old('description_hn') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="description_ur[]">@if($near){{ $near[$j]->description_ur }} @else {{ old('description_ur') }} @endif</textarea>
                                </div>
                            </div>
