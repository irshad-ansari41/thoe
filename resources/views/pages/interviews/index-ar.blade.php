...
<style>
    ...
    .az-pcontent{text-align: right!important;}
</style>
@stop
        ...
        <div class="container">
            ...
            <div class="row mb0 press-news-header">
                <div class="col s12 m11">
                    ...
                    <div class="az-pcontent" style=" width: 90%; text-transform: initial;display:none">
                        ...
                        <?php if ($pres->interview_photo) { ?>
                            <div class="col m4" >
                                <a href="<?= $pres->slug_en ?>"  target="_blank" style="text-decoration:none;"> 
                                    <img alt="<?= trim($pres->interview_title_ar) ?>" src="<?= asset('assets/images/media/interviews') ?>/<?= $pres->interview_photo ?>" class="responsive-img">
                                </a>
                            </div>
                        <?php } ?>
                        <div class="col <?= $pres->interview_photo ? 'm8' : 'm12' ?>">
                            <h4 class="m0"><a href="<?= $pres->slug_ar ?>" target="_blank" style="text-decoration:none;">  <?= $pres->interview_title_ar ?> </a></h4>
                            <i><?= date("d F Y", strtotime($pres->interview_date)) ?></i><br/>
                            <?= strip_tags($pres->long_desc_ar, '<p><br/>'); ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<?= $pres->slug_ar ?>" target="_blank" style="font-size:12px;color:grey;"><u><strong>Read full article here</strong></u></a>
                        </div>
                    </div>
