                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->title_ch }} @endif" name="title_ch"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->title_hn }} @endif" name="title_hn"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->title_ur }} @endif" name="title_ur"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Subtitle (Chinese)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->short_description_ch }} @endif" name="short_description_ch"
                                           placeholder="Enter Subtitle" />
                                </div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Subtitle (Hindi)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->short_description_hn }} @endif" name="short_description_hn"
                                           placeholder="Enter Subtitle" />
                                </div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Subtitle (Urdu)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($steps){{ $steps->short_description_ur }} @endif" name="short_description_ur"
                                           placeholder="Enter Subtitle" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="long_description_ch" rows="4">@if($steps){{ $steps->long_description_ch }} @else {{ old('long_description_ch') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="long_description_hn" rows="4">@if($steps){{ $steps->long_description_hn }} @else {{ old('long_description_hn') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="long_description_ur" rows="4">@if($steps){{ $steps->long_description_ur }} @else {{ old('long_description_ur') }} @endif</textarea>
                                </div>
                            </div>
