                    ...
                    <div class="panel-body">
						...
						@if($menu->type=="1")
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ $menu->title_ch }}" name="title_ch"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ $menu->title_hn }}" name="title_hn"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ $menu->title_ur }}" name="title_ur"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
