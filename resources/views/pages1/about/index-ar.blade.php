...
<style>body{text-align:right!important}
    ...
    .az-footer .ion-ios-email-outline{font-size:30px;float:left;margin-top:-15px;margin-right:9px;margin-left:10px}
</style>
    ...
    <div class="container">
        ...
        <div class="row m0">
            <div class="col s12 p0">
                <div class="col s12 p0">
                    <?= generate_breadcrumb([url("$locale") => trans('words.home'), '' => trans('words.About Us')],$locale) ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-timeline">
        <div class="container">
            ...
            <div class="row">
                ...
                <?= !empty($value['title_ar']) ? $value['title_ar'] : '' ?></h5>
                                                                <div class="divider az-header-divider mb0" style="background: white;"></div>
                                                                <p class="az-pcontent az-pright"><?= !empty($value['description_ar']) ? $value['description_ar'] : '' ?></p>
                                                            </div>
                                                        </div>
