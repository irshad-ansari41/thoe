...
<section class="az-section">
                    ...
                    <div class="col s12" style="margin-bottom: 2rem;">
                        ...
                        <div class="col s12 m6 p0">
                            <h4 style="font-size: 15px;font-weight: 100">         
                                <span class="ion-ios-telephone" style="font-size: 25px;margin: 0px 10px;"></span> 
                                <span style="font-weight: 500;font-size: 20px;">
                                    <a style="font-family: initial !important;" href="#"  class="telephone" data-telephone="97145184555">800 CARES (22737) </a>
                                </span>
                            </h4>
                        </div>
                        <div class="col s12 m6 p0">
    ...
    <span style="font-weight: 500;"><a href="#" class="telephone" data-telephone="80029494">{{trans('words.tollfree_no')}}</a></span> -->
                    ...
                    <div class="col s12 m6" style="padding-left: 9px;">
                        ...
                        <h4 style="font-size: 15px;font-weight: 100;">
                            ...
                            <span class="num-fo" style="font-size: 20px;font-weight: 500;">
                                <a href="#" class="num-fo telephone" data-telephone="97143596673" >
                                ...
                                <div class="col s12 m6 pay-mob">
                                    <div class="input-field col s12" style="border: 1px solid #e4e4e4;border-radius: 2px;    float: left !important;">
                                        ...
                                        <div class="col s12">
                                            <div class="input-field col s12" style="border: 1px solid #e4e4e4;border-radius: 2px;">
                                                <div class="col s12">
                                                    <textarea id="textarea1" style="border-bottom: none;margin-bottom: 0;font-size: 15px;letter-spacing: 1px;font-weight: 100;" placeholder="{{trans('words.Message *')}}" class="materialize-textarea" name="comment" required></textarea>
                                                </div>
                                            </div>
                                        </div>
