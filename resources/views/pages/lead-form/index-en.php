                ...
                <table width="320" cellpadding="5"  cellspacing="5">
                    <tr>
                        <td colspan="2">
                            ...
                            <small  class="txt-white-err valid" id='msg-name'>Please enter your name.</small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <small  class="txt-white-err valid" id='msg-email'>Please enter your email.</small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding: 0 5px;">
                            <small  class="txt-white-err valid" id='msg-country_code'>This field is required.</small>
                            <small  class="txt-white-err valid" id='msg-mobile'>Please enter mobile number.</small> 
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white-err valid" id='msg-nationality'>Please select your nationality.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white-err valid" id='msg-country'>Please select your residence country.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white-err valid" id='msg-language'>Please select language.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <small>
                                <a id="refreshbtn" style="color: #fff; position: relative; padding: 4px 0px 0px 0px; cursor: default; float: right; display:none;">
