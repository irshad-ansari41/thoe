...
<style>
    ...
    @media screen and (max-width: 768px) {
        .MobSection{ 
            background-color: #1b619a; position: fixed; bottom: 0px; 
        ...
        .imgheight{ min-height: 456px; max-height: 685px; }
        .smallSlide{width: 100%;}
        .navbar{background-color:#084473}
        .home_2{top:-50px !important; height:auto!important; background:#fff!important; }
...
<div class="wrapper">
    ...
    <div id="page-content_home">
        ...
        <div class="home_2">
            ...
            <!--div id='stick-form' class="mobiledevices" style="position:absolute; top:46%; right:4%; z-index: 99999;">
                            ...
                            <?php if(!empty($slider->banner_short_description_en)): ?>
                                ...
                                <div class="container Smsgbox">
                                    <div class="title col-lg-6  col-md-6 col-sm-8 col-xs-9">
                                        <!--<h2 class="vsmall" style="margin-bottom:7px !important;"><b>Eid Al Adha Offers</b></h2>-->
                                        ...
                                        <span class="ffs-bs mobileds">
                                            <a data-toggle="modal"  data-target="#lead-form-model" data-campaign="EidAlAdhaOffers" class="btn btn-default btn-small pointer">
                                                ENQUIRE NOW
                                            </a>
                                        </span>
                                        <?php endif;?>
