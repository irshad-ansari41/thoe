...
<html lang="en">
    ...
    <body style="background:#172c5b; background-color:#172c5b; width:595px; margin:0 auto; font-family:Helvetica; font-size:13px;" bgcolor="#172c5b">
                            ...
                            <option value="{{$value->id}}" {{!empty($get['projectname']) && $value->id == $get['projectname'] ? 'selected':''}}>
                                ...
                                <?php 
                                    if($get['projectname']== $value->id )
                                    {
                                        ...
                                        $header_image ='https://azizidevelopments.com/assets/images/properties/'.$gallery_location_area;
                                        $holder_image = 'https://azizidevelopments.com/assets/images/properties/'.$gallery_location_area;
                                    } 
                                ?>
                        ...
                        <select name="buildingname" id="buildingname" class="form-control" required>
                            ...
                            @foreach($Properties as $key => $value)
                                ...
                                <?php 
                                    ...
                                    {
                                        $mobilization_percentage = $value->mobilization_percentage;
        ...
        <form action="{{route('csu.csusend')}}" method="Post">
            ...
            <table width="595" border="0" align="center" style="background:#e9ecef; background-color:#e9ecef;" bgcolor="#e9ecef" 
                <tr>
                    <td style="padding:15px 20px; margin:0px;" width="90" >Email Address:</td>
                    <td align='left' style="padding:15px 20px; margin:0px;" width="300">
                ...
                @if ($errors->any())
                    <tr>
                        ...
                        <td colspan="4" style="padding:0px 20px 20px 20px; margin:0px; text-align: center; color:red;">{{ $error }}</td>
                        @endforeach
                    </tr>
                @endif   
            </table>
