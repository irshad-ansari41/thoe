                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="short_description_ch">{{ $contents->short_description_ch }}</textarea>
                                </div>
                            </div>
                            <div class="form-group ch_field">
                                <label class="col-md-3 control-label" name="description">Description (chinese)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ch">{{ $contents->description_ch }}</textarea>
								</div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="short_description_hn">{{ $contents->short_description_hn }}</textarea>
                                </div>
                            </div>
                            <div class="form-group hn_field">
                                <label class="col-md-3 control-label" name="description">Description (hindi)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_hn">{{ $contents->description_hn }}</textarea>
								</div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="short_description_ur">{{ $contents->short_description_ur }}</textarea>
                                </div>
                            </div>
                            <div class="form-group ur_field">
                                <label class="col-md-3 control-label" name="description">Description (urdu)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ur">{{ $contents->description_ur }}</textarea>
								</div>
                            </div>
