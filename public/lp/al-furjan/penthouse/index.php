...
$website_url = "https://azizidevelopments.com/en/dubai/al-furjan?afm=1";
?>
<!DOCTYPE html>
    ...
    <body>
                        ...
                        <div class=row>
                            <div class="logo col-md-9 col-sm-6 col-xs-6" data-wow-delay=1s>
                                <div class=logo-image>
                                    <a href='#'><img src="../images/logo_Azizi.png" alt></a>
                                </div>
                            </div>
                            <div class="logo col-md-3 col-sm-6 col-xs-6" data-wow-delay=1s>
                                <div class=logo-image>
                                    <a href='#'><img src="../images/logo.png" alt align=right /></a>
                                </div>
                            </div>
                        ...
                        <div class=row>
                            <div class=col-md-8>
                                <div class=slider-text>
                                    <h2>Premium living in Al Furjan</h2>
                                    <br/>
                                    <p>
                                        Step into the Penthouse of your dreams<br/>
                                        2-storey units with spacious terraces<br/>
                                        Panoramic views of the Dubai Marina skyline<br/>
                                        Prices starting from AED 1,790,000, with monthly installments from AED 6,896<br/>  
                                        Handover in 2019, limited units available<br/>
                                    </p>
                ...
                <div class="gallery wrapper clearfix">
                    <div class=container>
                        <div class="title text-center wow fadeIn">
                            <h2><span class=bold>Al Furjan</span> Projects</h2>
                        </div>

                        <section id=grid class="grid clearfix mobile-hide">
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href="../images/gallery/lg/samia-large.jpg" data-fancybox="gallery-1" data-title="Candace Acacia by Azizi">
                                <figure>
                                    <img src="../images/gallery/samia-thumb.jpg" />
                                    <svg viewBox="0 0 180 500" preserveAspectRatio=none>
                                    <path d="M 0 0 L 0 182 L 90 126.5 L 180 182 L 180 0 L 0 0 z "/>
                                    </svg>
                                    <figcaption>
                                        <span>Azizi Samia</span>
                                    </figcaption>
                                </figure>
                            </a>
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href="../images/gallery/lg/star-large.jpg" data-fancybox="gallery-1" data-title="Candace Aster by Azizi">
                                <figure>
                                    <img src="../images/gallery/star-thumb.jpg" />
                                    <svg viewBox="0 0 180 500" preserveAspectRatio=none>
                                    <path d="M 0 0 L 0 182 L 90 126.5 L 180 182 L 180 0 L 0 0 z "/>
                                    </svg>
                                    <figcaption>
                                        <span>Azizi Star</span>
                                    </figcaption>
                                </figure>
                            </a>
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href="../images/gallery/lg/farishta-large.jpg" data-fancybox="gallery-1" data-title="Azizi Daisy">
                                <figure>
                                    <img src="../images/gallery/farishta-thumb.jpg" />
                                    <svg viewBox="0 0 180 500" preserveAspectRatio=none>
                                    <path d="M 0 0 L 0 182 L 90 126.5 L 180 182 L 180 0 L 0 0 z "/>
                                    </svg>
                                    <figcaption>
                                        <span>Azizi Farishta</span>
                                    </figcaption>
                                </figure>
                            </a>
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href="../images/gallery/lg/plaza-large.jpg" data-fancybox="gallery-1" data-title="Azizi Feirouz">
                                <figure>
                                    <img src="../images/gallery/plaza-thumb.jpg" />
                                    <svg viewBox="0 0 180 500" preserveAspectRatio=none>
                                    <path d="M 0 0 L 0 182 L 90 126.5 L 180 182 L 180 0 L 0 0 z "/>
                                    </svg>
                                    <figcaption>
                                        <span>Azizi Plaza</span>
                                    </figcaption>
                                </figure>
                            </a>
                            <a class="wow fadeInUp b24-web-form-popup-btn-42" data-path-hover="M 0,0 0,38 90,58 180.5,38 180,0 z" href="../images/gallery/lg/shaista-large.jpg" data-fancybox="gallery-1" data-title="Azizi Freesia">
                                <figure>
                                    <img src="../images/gallery/shaista-thumb.jpg" />
                                    <svg viewBox="0 0 180 500" preserveAspectRatio=none>
                                    <path d="M 0 0 L 0 182 L 90 126.5 L 180 182 L 180 0 L 0 0 z "/>
                                    </svg>
                                    <figcaption>
                                        <span>Azizi Shaista</span>
                                    </figcaption>
                                </figure>
                            </a>
                        </section>
                ...
                <div class="gallery wrapper clearfix pbottom">
                    <div class=container-flud>
                        <div class="col-sm-12 col-md-12" style="padding:0;">
                            <div style="width: 100%"><iframe width="100%" height="400" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;coord=25.028419,55.134223&amp;q=Al%20Furjan+(Azizi%20Developments)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/create-google-map/">Embed Google Map</a></iframe></div>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <script>
            ...
            if (campaign !== '' && campaign !== null) {
                ...
                sessionStorage.setItem("utm_campaign", 'Al Furjan Penthouse');
            }
