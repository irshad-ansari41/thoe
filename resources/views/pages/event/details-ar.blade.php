            ...
            <div class="col s12 m4">
                <div class="col s12 event-detail">
                    ...
                    <p class="az-pcontent social-share"><strong style="margin-right: 15px;font-size: 12px;">شارك: </strong>
                        ...
                        <a href="https://twitter.com/share?url=<?= url('/') ?>/mediacenter-eventgallery-detail/<?= $content['slug'] ?>&via=AZIZI Developments&text=<?= $content->event_title ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Twitter"><i class="ion-social-twitter" ></i></a>
