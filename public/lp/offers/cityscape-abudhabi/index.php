...
<html>
    <head>
        <title>Azizi Developments &mdash; Cityscape Offers</title>
        ...
        <div class="page" id="top">
                ...
                <div class="full-wrapper relative clearfix CenterMenu">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist scroll-nav local-scroll">
                            ...
                            <li><a href="<?= PAGE_URL ?>/cityscape-abudhabi/ar/" class="active">العربية</a></li>
                            <!-- End Item With Sub -->
            ...
            <div class="bg-dark relative" id="home">
                <div class="fullwidth-gallery">
                    ...
                    <!-- Slide Item -->
                    <section class="home-section bg-scroll bg-dark-alfa-30" data-background="https://azizidevelopments.com/assets/images/home_banners/1553589082.jpg">
            ...
            <!-- Section -->
            <section class="small-section bg-gray-lighter" id="Azizi-Riviera-Select">
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img class="img-responsive" src="https://azizidevelopments.com/uploads/2019/04/Cityscape-AUH-Mailer-Flag.jpg" alt=""/>
                                </div>
                                <div class="col-md-8 mb-30">
                                    ...
                                    <div class="span2">Monthly payment plan starts after 3 months</div>
                ...
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img class="img-responsive" src="https://azizidevelopments.com/assets/images/ips/IPS-All-Offers-Emailer_Riviera.jpg" alt="" />
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
                                        Part of the mega retail, equestrian, golfing and waterfront lifestyle, in Meydan, Azizi Riviera is an affordable premium escape in the heart of the city. Azizi Riviera Select is a Cityscape Exclusive collection of new units with payment plan options.
                                    </p>
                                    <span class="title2">Limited Time Offer</span>
                                    <table>
                                        ...
                                        <tr><td>1 bedroom</td><td>30% - 70%</td><td>AED 710,400</td></tr>
<!--                                        <tr><td>2 bedroom</td><td>10% - 90%</td><td>AED 1,739,000</td></tr>-->
                                        <tr><td>3 bedroom</td><td>5% - 95%</td><td>AED 1,329,600</td></tr>
                                    </table>
                ...
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img class="img-responsive" src="https://azizidevelopments.com/assets/images/ips/IPS-All-Offers-Emailer_BAYT.jpg" alt="" />
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
                ...
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img class="img-responsive" src="https://azizidevelopments.com/assets/images/ips/IPS-All-Offers-Emailer_Al-Furjan.jpg" alt="" />
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
                ...
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img  class="img-responsive"  src="https://azizidevelopments.com/assets/images/ips/IPS-All-Offers-Emailer_Victoria.jpg" alt="" />
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <!-- Media Gallery -->
                                    <img class="img-responsive" src="https://azizidevelopments.com/assets/images/ips/IPS-All-Offers-Emailer_Mina.jpg" alt="" />
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
            ...
            <!-- Azizi Retail Section -->
            <section class="small-section bg-white-lighter" id="Mina-by-Azizi" >
                <div class="container relative">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="blog-item-title font-alt mb-10" >
                            ...
                            <div class="row" >
                                <div class="col-md-4">
                                    <img class="img-responsive" src="https://azizidevelopments.com//uploads/2019/04/Cityscape-AUH-Mailer-Retail-Image.jpg" alt=""/>
                                </div>
                                <div class="col-md-8 mb-30">
                                    <!-- Text Intro -->
                                    <p class="p-text">
            ...
            <section class="small-section bg-gray-lighter" id="enquire">
