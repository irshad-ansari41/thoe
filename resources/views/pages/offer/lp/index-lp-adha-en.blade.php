        ...
        <div class="row">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Adha Offer" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-1.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-1.jpg" class="responsive-img pro-image">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Adha Offer" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-2.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-2.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Adha Offer" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-3.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-3.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Adha Offer" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-4.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-4.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Adha Offer" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-5.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-5.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
...
<script>
    ...
    if (campaign !== '' && campaign !== null) {
        ...
        sessionStorage.setItem("utm_campaign", 'Landing page Adha Offers');
    }

    sessionStorage.setItem("ips_offers_url", '<?= SITE_URL ?>/lp/adha-offers');
</script>             
