...
<style>
    ...
    @media only screen and (min-width: 768px) {
        .section-border-left {border-left:7.5px solid #dedede;}
        .section-border-right {border-right:7.5px solid #dedede;}
    }
...
<section class="py-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6  border-left">
                    <div class="white-section">
                        ...
                        <form action="{{route('payment.confirmation')}}" method="POST" id="form-booking">
                            <input name="project_name" value="{{$project->slug}}" type="hidden">
                            <input name="unit_id" value="" id="field-uid" type="hidden">
                            <input name="payment_amount" value="20000" id="field-amount" type="hidden">
                            <input name="currency" value="AED" id="field-currency" type="hidden">
                            <input name="payment_for" value="Online Booking" type="hidden">
                                ...
                                <div class="col-12 col-sm-6 form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 col-sm-3 no-padding">
                                            <input name="country_code" class="form-control bg-light" value="" type="text" id="country_code" value="{{old('country_code')}}" readonly="readonly">
                                        </div>
                                        <div class="col-6 col-sm-6 no-padding-left">
                                            <input name="mobile_number" class="form-control" value="" type="text" id="phone" value="{{old('mobile_number')}}" pattern="\d*" required="required" minlength="7" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 form-group">
                                    <div class="field-title">E-mail: *</div>
                                    <div class="field-wrapper field-EMAIL"><input name="email_id" class="form-control" value="{{old('email_id')}}" type="text" required="required"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 form-group">
                                    ...
                                    <div class="field-wrapper field-P_ZIP_POBOX"><input name="post_code" class="form-control" value="{{old('post_code')}}" pattern="\d*" type="text" minlength="4" maxlength="8" required="required"></div>
                                </div>
                            </div>
                            <div class="row m-t-s">
                                <div class="col-12 col-sm-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" value="" required="required"><span class="terms-label">I acknowledge that I have read and agree to the <a href="<?=SITE_URL?>/en/privacy" class="popup-inline cboxElement">terms and conditions</a></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
    ...
    <div class="container bg-white">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6  border-right">
                <div class="white-section">
                    <h5>You're in complete control</h5>
                    ...
                    <hr/>
                    <h5>Best price guaranteed online</h5>
...
<script>
    $(document).ready(function () {
        ...
        $('input[name=email_id]').on('blur', function () {
