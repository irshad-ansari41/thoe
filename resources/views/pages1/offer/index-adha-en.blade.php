...
<section>
    <div class="parallax-container valign-wrapper only-heading" style="background-image:url('<?= SITE_URL ?>/emailer/adha-offers/Offer-page-Slidder-2.jpg');">
        <img alt="Cityscape - Azizi Developments" src="<?= SITE_URL ?>/emailer/adha-offers/Offer-page-Slidder-2.jpg" class="imgtag"/>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 pro-holder center-align Completed">
                <h1 class="span2"><b>Eid Al Adha Offers</b></h1>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Eid Al Adha Offers" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-1.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-1.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 14px!important;letter-spacing: 1px;">1% booking fee</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Eid Al Adha Offers" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-2.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-2.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 13.5px!important;letter-spacing: 1px;"> Riviera in Meydan </h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Eid Al Adha Offers" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-3.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-3.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 14px!important;letter-spacing: 1px;">Highest rental yields</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Eid Al Adha Offers" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-4.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-4.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 14px!important;letter-spacing: 1px;">DXB’s #1 destination </h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    <img alt="Eid Al Adha Offers" src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-5.jpg" data-src="<?= SITE_URL ?>/emailer/adha-offers/adha-offer-carousel-5.jpg" class="responsive-img pro-image">
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 14px!important;letter-spacing: 1px;">mmm... </h5>                       
                    </div>
                </div>
...
<script>
    ...
    if (campaign !== '' && campaign !== null) {
        ...
        sessionStorage.setItem("utm_campaign", 'Adha Offers');
    }

    sessionStorage.setItem("ips_offers_url", '<?= SITE_URL ?>/en/adha-offers');
</script>             
