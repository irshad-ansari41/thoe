...
<section>
    <div class="parallax-container valign-wrapper only-heading" style="background-image:url('<?= SITE_URL ?>/emailer/uk-offers/offer-slider-image-7-2.jpg');">
        ...
        <?= SITE_URL ?>/emailer/diamond-offers/img/offer-slider-image-7-2.jpg 800w"
        ...
        <div class="col s12 center-align card tag-pro">
            ...
            <h1 style="text-align:center; font-weight: 200;">3rd - 8th</h1>            
        </div>
    ...
    <div class="container" style="width:100%;">
        <div class="row">
            ...
            <div class="col s12 m12 pro-holder center-align Completed mobileds-1">
                ...
                <h6 style="padding-bottom:20px;color:#fff;font-size: 18px !important;padding: 20px;">Discover our exceptional Diamond Week Offers. Get the most competitive rental yields and substantial rebates when buying your home this week.</h6>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 pro-holder center-align Completed mobileds">
                <h1 class="span2"><b></b></h1>
                <h6 style="padding-bottom:20px;">Discover our exceptional Diamond Week Offers. Get the most competitive rental yields and substantial rebates when buying your home this week.</h6>
            </div>
        ...
        <div class="row">
            ...
            <div class="col s12 m3 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0">
                    ...
                    <div class="col s12 title-holder">
                        <h5 style="text-transform:unset;font-size: 14px!important;letter-spacing: 1px;"> Up to 19% value back </h5>                       
                    </div>
                </div>
...
<script>
    ...
    if (campaign !== '' && campaign !== null) {
        ...
        sessionStorage.setItem("utm_campaign", 'Landing Page Diamond Week Offers');
    }

    sessionStorage.setItem("ips_offers_url", '<?= SITE_URL ?>/lp/diamond-week-offers');
</script>             
