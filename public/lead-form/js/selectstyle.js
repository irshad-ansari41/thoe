    ...
    $.fn.selectstyle = function (option) {
        ...
        this.each(function () {
            var $this = $(this),
                    ...
                    id = $this.attr('id');
            setting.width = (parseInt($this.attr('width') == null ? $this.width() - 20 : $this.attr('width'))) + 'px';
        ...
        $("body").delegate("div#select_style", "click", function (e) {
            ...
            $(this).parent('div').find('ul#select_style_ul div.search input').focus();
        });
        $("body").delegate("ul#select_style_ul li", "click", function (e) {

            var txt = $(this).data('title');
            var vl = $(this).attr('value'); 
            var sid = $(this).parent('ul').attr('sid');
