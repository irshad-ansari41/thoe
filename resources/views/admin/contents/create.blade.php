                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ old('title_en') }}" name="title_ch"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ch">{{ old('description_ch') }}</textarea>
								</div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ old('title_hn') }}" name="title_hn"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_hn">{{ old('description_hn') }}</textarea>
								</div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="{{ old('title_ur') }}" name="title_ur"
                                           placeholder="Enter Title" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ur">{{ old('description_ur') }}</textarea>
								</div>
                            </div>
