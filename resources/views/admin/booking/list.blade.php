            ...
            <div class="panel-body">
                <form action="{{ url('/admin/payment/search') }}" method="post">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        <tr>
                            <td><input type="text" name="order_no" value="{{ $sdata['order_no'] }}" placeholder="Order No"></td>
                            <td><input type="text" name="email" value="{{ $sdata['email'] }}" placeholder="Email Address"></td>
                            <td>
                                <select name="status">
                                        ...
                                        <div class="modal-body col-md-12" style="">
                                            <div class="col-md-12" style="border: 1px solid #dedede;padding: 25px 10px;">
                                                ...
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;"><?php echo date("d-m-Y h:i:s", strtotime($result->payment_date)); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;">{!! $result->payment_amount !!} AED</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                        <p style="margin-bottom: 0;"><b>Property Name :</b></p>
                                                    </div>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                        <p style="margin-bottom: 0;"><b>Floor or Block :</b></p>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;">{!! $result->floor_block !!}</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                        <p style="margin-bottom: 0;"><b>Unit No. :</b></p>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;">{!! $result->unit_number !!}</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                ...
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                        <p style="margin-bottom: 0;"><b>Alternate Phone Number :</b></p>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;">{!! $result->alt_phone_number !!}</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                ...
                                                <div class="col-md-12" style="border-bottom: 1px solid #e4e4e4;padding: 5px 0px;">
                                                    <div class="col-md-3">
                                                        <p style="margin-bottom: 0;"><b>Payment Description :</b></p>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <p style="margin-bottom: 0;">{!! $result->payment_desc !!}</p>
                                                    </div>
                                                </div>
