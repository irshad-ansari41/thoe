...
<html>
    <head>
        ...
        <title>Constructions Updates - <?php date('f-j-Y') ?></title>
        <style type="text/css">
                ...
                <td>
                    ...
                    bgcolor="#f6f6f6"  cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="padding:10px 40px;font-family: tahoma;font-size: 16px;">
                                <p> 
                                    Please see below the construction update for <?=$CSUpdate['BulidingName']; ?> which is due for completion in <?=$CSUpdate['nfcstatus']?> 
                                </p>
                            </td>
                                 ...
                                 bgcolor="#f2f2f2" width="90%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:1px solid #e6e5e5;">
                                            <img src="https://azizidevelopments.com/assets/images/constructions-updates-progress-bars/mobilization/<?=$CSUpdate['fMOBILIZATION'] ?>.jpg" width="110">
                                        </td>

                                        <td style="border:1px solid #e6e5e5;">
                                            <img src="https://azizidevelopments.com/assets/images/constructions-updates-progress-bars/structure/<?=$CSUpdate['STRUCTURE'] ?>.jpg" width="110">
                                        </td>

                                        <td style="border:1px solid #e6e5e5;">
                                            <img src="https://azizidevelopments.com/assets/images/constructions-updates-progress-bars/mep-works/<?=$CSUpdate['GROUND'] ?>.jpg" width="110">
                                        </td>

                                        <td style="border:1px solid #e6e5e5;">
                                            <img src="https://azizidevelopments.com/assets/images/constructions-updates-progress-bars/finishing/<?=$CSUpdate['FINISHING'] ?>.jpg" width="110">
                                        </td>
