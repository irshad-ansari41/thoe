...
<section>
    <div class="parallax-container valign-wrapper only-heading" style="background-image:url('<?= SITE_URL ?>/uploads/2019/06/eid-offers-banner.jpg');">
        <img alt="Cityscape - Thoe Developments" src="<?= SITE_URL ?>/uploads/2019/06/eid-offers-banner.jpg" class="imgtag"/>
        ...
        <div id='stick-form' class="mobileds">
            ...
            <iframe src="https://thoe.com/<?= $locale ?>/lead-form" class="iframe-lead-form" border="0" style="width:349px;height:330px;border:none;" scrolling="No"></iframe>                            
        </div>
