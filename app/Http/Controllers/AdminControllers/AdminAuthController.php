...
use App\Http\Controllers\JoshController as JoshController;
...
class AdminAuthController extends JoshController {
    ...
    public function getLogout() {
        ...
        return Redirect::to('admin/login2')->with('success', 'You have successfully logged out!');
    }
