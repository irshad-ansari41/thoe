            ...
            <form id="lead-form" action="<?= SITE_URL ?>/save-lead" method="post" >
                <table width="100%" cellpadding="5"  cellspacing="5" style="width:600px !important; ">
                    ...
                    <tr>
                        ...
                        <td width="10%" valign="top">
                            <button type="submit" class="btn btn-outline-dark btn-block submit-btn"  value="Submit" name="Save">
                                سجل الآن
                            </button>
                        </td>
                    ...
                    <tr>
                        <td colspan="5" style="padding: 0 5px;">
                            <small  class="txt-red valid" id='msg-name'>
                                الاسم الكامل
                            </small>
                            <small  class="txt-red valid" id='msg-email'>
                                البريد الالكتروني
                            </small>
                            <small  class="txt-red valid" id='msg-country_code'>
                                البلد
                            </small>
                            <small  class="txt-red valid" id='msg-mobile'>
                            رقم الهاتف   
                            </small> 
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="5">
                            ...
                            <small>
                                <a id="refreshbtn" style="color: #fff; float: left; position: relative; padding:4px 20px 0px 20px; cursor: default; display: none;">
                                    إعادة التحميل
