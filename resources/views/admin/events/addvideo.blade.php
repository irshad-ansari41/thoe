                ...
                <div class="panel-body">
                    <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group en_field">
                            ...
                            <div class="col-md-8">
                                <textarea name="gallery_long_title_en" class="form-control">@if($results){{ $results->gallery_long_title_en }} @endif</textarea>
                            </div>
                        </div>
                        <div class="form-group ar_field">
                        ...
                        <div class="form-group en_field">
                            ...
                            <div class="col-md-8">
                                <textarea id="ckeditor_standard" name="short_description_en" class="form-control">@if($results){{ $results->short_description_en }} @endif</textarea>
                            </div>
                        </div>
                        <div class="form-group ar_field">
                            <label class="col-md-3 control-label hidden-xs">Short Description(Arabic)</label>
                            <div class="col-md-8">
                                <textarea id="ckeditor_standard1" name="short_description_ar" class="form-control">@if($results){{ $results->short_description_ar }} @endif</textarea>
                            </div>
                        </div>
