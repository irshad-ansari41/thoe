...
$website_url = "https://azizidevelopments.com/ar/dubai/palm-jumeirah/azizi-mina";
?>
<!DOCTYPE html>
    ...
    <body>
                        ...
                        <div class=row>
                            <div class=col-md-8>
                                <div class=slider-text>
                                    <h3>أحدث المشاريع السكنية في نخلة جميرا</h3>
                                    <br/>
                                    <p>
                                         عش الحلم في نخلة جميرا.
                                        <br/>
                                         دفعات شهرية بقيمة 9,255 درهماً إماراتياً.
                                        <br/>
                                         إعفاء من رسوم الخدمة لمدة سنتين.
                                        <br/>
                                         شاطئ خاص.
                                        <br/>
                                    </p>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="agent-detail wow fadeIn" data-wow-delay=0.5s>
                                ...
                                <div class=facilities-content>
                                    ...
                                    <p class=intro>يضم مينا من عزيزي 178 وحدة سكنية متنوعة ما بين شقق بغرفة وغرفتي نوم، وشقق بانتهاوس. تتميّز هذه الواجهة البحرية التي تعانق الشاطىء والمطورة بشكل رائع، بإطلالة ساحرة على البحر ورمال إحدى أكثر الوجهات رواجاً في العالم.
                ...
                <div class="gallery wrapper clearfix">
                    <div class=container>
                        <div class="title text-center wow fadeIn">
                            <h2><span class=bold>عزيزي مينا</span> </h2>
                        </div>
        ...
        <footer id=footer class="wrapper clearfix">
            <div class="footer-text wow fadeIn text-center">
                ...
                <a class="button-normal yellow b24-web-form-popup-btn-105" id=open-lead-form data-toggle=modal data-target=#lead-form-model>سجل الآن</a>
            </div>
