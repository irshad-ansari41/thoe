...
<html dir=ltr lang=en-US>
    <head>
        ...
        <![endif]-->
        <title>Azizi Developments - All Projects</title>
        <style type=text/css>div.login{border-radius:2px;background-color:#5f84f2;padding:4px 8px;cursor:pointer;display:none}#myVideo{position:fixed;right:0;bottom:0;min-width:100%;width:100%;min-height:100vh}@media(max-width:768px){#myVideo{display:none}}</style>
                ...
                <div class="agent clearfix">
                    <div class=row>
                        <div class="col-sm-12 col-md-6"><div class="agent-img wow fadeInLeft">
                                <div id=map><img lsrc=https://d1uynapdozt6zg.cloudfront.net/rangerover-lp/map.png alt=Map></div>
                            </div></div>
