...
<style>
    ...
    .container{margin:0 auto!important;max-width:1280px!important;width:90%!important}
    .navigation .navbar a.drop-left, .navigation .navbar a.drop-close {
        padding: 35px 35px 35px 15px;
    }

    #stick-form{/*background:rgba(21, 88, 149, 0.8) !important;*/ background:rgba(0, 0, 0, 0.52) !important; height: 120px;padding: 10px 0px;border:2px solid #dadada;position: absolute;right: 35px;top:35px}
    ...
    <div id="page-content_home">
        ...
        <div class="home_2">
            ...
            <div id='stick-form' class="mobiledevices" style="position:absolute; top:calc(100% - 210px); right:2%; z-index: 99999; border:none;">
                <h5 class="info-color white-text text-center" style="text-transform: uppercase; font-size: 18px!important; text-align: right; margin: 10px 10px 0px 25px;display: block; color:#fff !important;">
                    <strong>
                        طلب معاودة الإتصال
                    </strong>
                </h5>
