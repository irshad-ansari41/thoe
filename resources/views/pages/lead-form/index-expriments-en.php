...
<html lang="en">
    <head>
        ...
        <style>
            body{background: #0d1e35; margin:20px auto;}
    ...
    <body>
        <div align="center" >
            ...
            <form id="lead-form" action="<?= SITE_URL ?>/save-lead-exp" method="post" >
                <table width="320" cellpadding="5"  cellspacing="5">
                    <tr>
                        <td colspan="2">
                            <input type="text" class="form-control lead_name"  placeholder="Full Name*"  name="name" id="name"  maxlength="30">
                            <small  class="txt-white valid" id='msg-name'>Please enter your name.</small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <small  class="txt-white valid" id='msg-email'>Please enter your email.</small>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding: 0 5px;">
                            <small  class="txt-white valid" id='msg-country_code'>This field is required.</small>
                            <small  class="txt-white valid" id='msg-mobile'>Please enter mobile number.</small> 
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white valid" id='msg-nationality'>Please select your nationality.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white valid" id='msg-country'>Please select your residence country.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                            ...
                            <small  class="txt-white valid" id='msg-language'>Please select language.</small>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <small  class="txt-white invalid" id='msg-captcha'></small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
        ...
        <script src="<?= SITE_URL ?>/lead-form/js/expriments.js"></script>
