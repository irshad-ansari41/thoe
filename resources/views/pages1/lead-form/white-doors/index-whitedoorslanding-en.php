...
<html lang="en">
    ...
    <body>
        ...
        <script>jQuery.ajax({url: '<?= url('cache-page') ?>', cache: false, data: {page_url: 'https://thoe.com/en/lead-form/white-door', user_id: '1'}, success: function (html) { }});
            ...
            var url = new URL('http://whitedoorestate.com/demo/index.html');
            ...
            if (campaign !== '' && campaign !== null) {
                ...
                sessionStorage.setItem("utm_campaign", 'White Door Landing Page');
            }
            ...
            sessionStorage.setItem("thank_url", 'http://whitedoorestate.com/thankyou.php');
            sessionStorage.setItem("website_page_url", 'http://whitedoorestate.com/index.html');            
        </script>
    </body>
</html>
