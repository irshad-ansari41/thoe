                ...
                <div class="panel-heading">
                    <div style="float:left;width:70%;">
                        <h3 class="panel-title">
                            @if($type=="edit")
                            Edit photo into construction
                            @else	
                            Add photo into construction
                            @endif
                        </h3>
                    </div>
                    <div>
                        ...
                        <div id="pimages">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" >
                                    Upload photo (NOTE: Photo 	dimension at least 1400*700) 
                                    <br><br> 
                                    Uploaded Date:{{date('j F Y',strtotime($res->created))}}
                                </label>
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                            <img src="{{asset('assets/images/properties')}}/{!! $project_location !!}/{!! $prop_location !!}/construction-update/{!! $res->image !!}" height="190" width="190" />
                                        </div>
...
<div class="form-group" id="one" style="display:none;">
    <label class="col-md-3 control-label" >Upload photo (NOTE: Photo dimension at least 1400*700)<br><br></label>
    <div class="col-md-8">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
