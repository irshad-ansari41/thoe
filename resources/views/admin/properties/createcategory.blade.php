                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group en_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="title_en"
                                           placeholder="Enter title" value="@if($category){{ $category->title_en }} @endif" />
                                </div>
                            </div>
							...
							<div class="form-group ar_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($category){{ $category->title_ar }} @endif" name="title_ar"
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($category){{ $category->title_ch }} @endif" name="title_ch"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($category){{ $category->title_hn }} @endif" name="title_hn"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($category){{ $category->title_ur }} @endif" name="title_ur"
                                           placeholder="Enter title" />
                                </div>
                            </div>
							...
							<input type="hidden" name="id" value="@if($type=="edit"){{ $category->id }}@endif">
