...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
           {!! Form::model($feature, array('url' => URL::to('admin/feature/' . $feature->id.'/edit'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                <div class="row">
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ URL::to('admin/feature') }}" class="btn btn-danger">@lang('feature/form.discard')</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
                <!-- /.row -->
