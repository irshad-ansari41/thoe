                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Project Title (Chinese)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->title_ch }} @endif" name="title_ch"
                                           placeholder="Enter Project title in Chinese" />
                                </div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Project Title (Hindi)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->title_hn }} @endif" name="title_hn"
                                           placeholder="Enter Project title in Hindi" />
                                </div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Project Title (Urdu)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->title_ur }} @endif" name="title_ur"
                                           placeholder="Enter Project title in Urdu" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Project Sub Title (Chinese)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->subtitle_ch }} @endif" name="subtitle_ch"
                                           placeholder="Enter Project sub title in Chinese" />
                                </div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Project Sub Title (Hindi)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->subtitle_hn }} @endif" name="subtitle_hn"
                                           placeholder="Enter Project sub title in Hindi" />
                                </div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Project Sub Title (Urdu)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="@if($project){{ $project->subtitle_ur }} @endif" name="subtitle_ur"
                                           placeholder="Enter Project sub title in Urdu" />
                                </div>
                            </div>
							...
							<div class="form-group ar_field">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ar">@if($project){{ $project->description_ar }} @endif</textarea>
								</div>
                            </div>
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label" name="">Project Long Description (Chinese)</label>
							...
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label" name="">Project Long Description (Hindi)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_hn">@if($project){{ $project->description_hn }} @endif</textarea>
								</div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label" name="">Project Long Description (Urdu)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="description_ur">@if($project){{ $project->description_ur }} @endif</textarea>
								</div>
                            </div>
