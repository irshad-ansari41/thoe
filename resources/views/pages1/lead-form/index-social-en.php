...
<html lang="en">
    ...
    <body style="background:rgba(21, 88, 149, 0.8)">
        <div align="center" >
            ...
            <form id="lead-form" action="https://thoe.com/save-lead-salesforace" method="post" >
                <table width="340" cellpadding="7"  cellspacing="7" style="background: #fff;margin-top: 50px;">
                    <tr>
                        <td colspan="2">
                            <h5 class="text-center" style="margin: 0">Social Media Lead Submission</h5>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2">
                            <select name="source" id="source" class="form-control txt-888" style="margin-top: 7px;">
                                ...
                                <option value="Twitter Message">Twitter Message</option>
