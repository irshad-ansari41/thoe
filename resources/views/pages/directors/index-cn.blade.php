...
<style>
    ...
    */
    ...
    p, .az-pcontent{ text-align: left !important; font-size: 14.5px !important;}
    .TPara{ padding: 0px 60px 20px 0px; }
    ...
    <div class="container">
        ...
        <div class="row m0">
            <div class="col s12 p0">
                <div class="col s12 p0">
                    <?= generate_breadcrumb([url("$locale") => trans('words.home'), '' => trans('words.Corporate Executives')]) ?>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container">    
                ...
                <div class="row rowgaps" >
                    <div class="col s12 m12 l3 xl3" data-aos="fade-right" data-aos-once="true">
                        ...
                        <img  alt="{{ $executive['chairment_alt'] }}"  src="{{ asset('assets/images/100-blank-img.jpg') }}" data-src="{{ asset('assets/images/100-blank-img.jpg') }}" data-src="{{asset('assets/images/executives/')}}/{{ $executive['chairmen_image'] }}" class="responsive-img">
                        @endif
                    </div>
                    <div class="col s12 m12 l9 xl9 gaps" data-aos="fade-in" data-aos-once="true">
                        <div class="desig-person mt0">
                            <div class="person-name">{{ $executive['chairmen_name_ch'] }}</div>
                            <div class="divider az-header-divider"></div>
                            <i>{{trans('words.Chairman, Azizi Group')}}</i>
                        </div>
                        <p class="az-pcontent">{!! $executive['chairmen_description_ch'] !!}</p>
                    </div>
                </div>
                <!-- end -->
            </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="row rowgaps">
                    ...
                    if($team->cateteam =="NON EXECUTIVE DIRECTOR"){ ?>    
                    @if(!empty($team->description_cn))
                    <div class="col s12 m12 l6 xl6" style="margin:0 0 35px 0;">
                        <div class="row hover08">
                            <div class="col s12 m12 l4 xl4" data-aos="fade-in" data-aos-once="true">
                                ...
                                <img alt="{{ $team->alt }}" src="{{ asset('assets/images/100-blank-img.jpg') }}" data-src="{{ asset('assets/images/100-blank-img.jpg') }}" data-src="{{asset('assets/images/team/')}}/{{ $team->image }}" class="responsive-img im-age">
                                
                            </div>
                            <div class="col s12 m12 l8 xl8 Sec-Team" data-aos="fade-out" data-aos-once="true">
                                <h5 class="person-name" style="margin:10px 0px;">{{ $team->name_cn }}</h5>
                                <h3 style="margin:0px 0px 15px 0px; font-size:11.5px; letter-spacing:1px; text-transform: uppercase; font-weight: bold;">{{ $team->designation_cn }}</h3>
                                <p class="TPara">
                                    {{ $team->description_cn }}
                                </p>
                                <?php if(!empty($team->long_description_cn)): ?>
...
<!-- Model Popup -->
<div id="co-exec-team-popup" class="modal" style="top: 3% !important;">
