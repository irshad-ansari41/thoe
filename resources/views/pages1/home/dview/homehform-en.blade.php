...
<style>
    ...
    .MyTicker{
        ...
        width: 642px; right: 2%; height: 83px;    
    }
    .MyTicker h2 {
    ...
    @media screen and (max-width: 1368px) and (min-width: 1280px){ .Smsgbox{left:25px !important; width: 88% !important;}}
    @media screen and (max-width: 1024px) {
        .MTicker{ bottom:-21% !important;}
        .mobiledevices,.MTicker{display: none;}
    ...
    .mob-menu .bb2 a{color: #000;font-weight: 800; padding:0 16px; font-size: 13.5px;}
    #stick-form{/*background:rgba(21, 88, 149, 0.8) !important;*/ background:rgba(0, 0, 0, 0.52) !important; height: 120px;position: absolute;right: 35px;top:35px}
    .text-center{height: auto !important;}
</style>
@stop
...
<div class="wrapper">
    ...
    <div id="page-content_home">
        ...
        <div class="home_2">
            ...
            <div id='stick-form' class="mobiledevices" style="position:absolute; top:calc(100% - 210px); right:2%; z-index: 99999; border:none;">
                <h5 class="info-color white-text text-center" style="text-transform: uppercase; font-size: 18px!important; text-align: left; margin: 10px 10px 0px 25px;display: block; color:#fff !important;">
                    <strong>Request A Call Back</strong>
                </h5>
                <div>
                    <iframe src="<?= SITE_URL ?>/<?= $locale ?>/lead-form2" class="iframe-lead-form" border="0" style="width:642px; height:190px; border:none;" scrolling="No"></iframe>
                </div>
                <?php if(!empty($_GET['test']) && $_GET['test'] ==1): ?>
                    <a id="refreshbtn" onclick="refreshIframe();" style="color: #fff; position: absolute; left:580px; bottom: 11px;padding: 0px 20px; cursor: default; display:none;">
                    ...
                    <div id="myCarousel-1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <p class="testimonial">
                                    We're especially happy with the facilities - it has everything one could wish for.
                                </p>
                                <p class="overview"><b>Zaed Abdul Latif </b> </p>
                            </div>

                            <!--div class="item">
                                <p class="testimonial">
                                    Overall Good services, recommended for kids playing area, The services are great.
                                </p>
                                <p class="overview"><b>Sunil Gaur</b> </p>
                            </div-->

                            <div class="item">
                                <p class="testimonial">
                                    A place to call home. We appreciate the great service - the staff is very friendly!
                                </p>
                                <p class="overview"><b>Cuneyt Alp Bayraktan</b> </p>
                            </div>
