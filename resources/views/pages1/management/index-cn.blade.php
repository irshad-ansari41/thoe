        ...
        <section>
            <div class="container" >   
                <div class="row rowgaps">
                    ...
                    <div class="col s12 m12 l9 xl9  gaps" data-aos="fade-in" data-aos-once="true">
                        <div class="desig-person mt0">
                            <div class="person-name">{{ $executive['ceo_name_ch'] }}</div>
                            <div class="divider az-header-divider"></div>
                            <i>{{trans('words.CEO THOE DEVELOPMENTS')}}</i> 
                        </div>
                        <p class="az-pcontent">{!! $executive['ceo_description_ch'] !!}</p>
                    </div>
                </div>
                <!-- end -->
            </div>
        ...
        <section class="sectiontwo">
            <div class="container" >   
                ...
                <div class="row rowgaps">
                    ...
                    <div class="col s12 m12 l9 xl9 gaps" data-aos="fade-in" data-aos-once="true">
                        <div class="desig-person mt0">
                            <div class="person-name">{{ $executive['deputy_ceo_name_ch'] }}</div>
                            <div class="divider az-header-divider"></div>
                            <i>{{trans('words.Deputy CEO, Thoe Developments')}}</i> 
                        </div>
                        <p class="az-pcontent">{!! $executive['deputy_ceo_description_ch'] !!}</p>
                    </div>
                </div>
                <!-- end -->
            </div>
