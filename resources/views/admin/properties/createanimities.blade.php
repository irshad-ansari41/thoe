                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">@if($aminitie->icon) <img src="{{asset('assets/images/icon')}}/{!! $aminitie->icon !!}" height="190" width="190" /> @endif</div>
