                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Explore Link(chineses)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="explore_link_ch"
                                           placeholder="Enter banner title in English" value="@if($bannerslider){{ $bannerslider->explore_link_ch }} @else {{ old('explore_link') }} @endif" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Banner Title (Chinese)</label>
							...
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Banner Title (Hindi)</label>
							...
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Banner Title (Urdu)</label>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label" name="banner_short_description_ch">Banner Short Description (Chinese)</label>
							...
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label" name="banner_short_description_hn">Banner Short Description (Hindi)</label>
							...
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label" name="banner_short_description_ur">Banner Short Description (Urdu)</label>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label" name="banner_long_description_ch">Banner Long Description (Chinese)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="banner_long_description_ch">@if($bannerslider){{ $bannerslider->banner_long_description_ch }} @else {{ old('banner_long_description_ch') }} @endif</textarea>
								</div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label" name="banner_long_description_hn">Banner Long Description (Hindi)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="banner_long_description_hn">@if($bannerslider){{ $bannerslider->banner_long_description_hn }} @else {{ old('banner_long_description_hn') }} @endif</textarea>
								</div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label" name="banner_long_description_ur">Banner Long Description (Urdu)</label>

                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="banner_long_description_ur">@if($bannerslider){{ $bannerslider->banner_long_description_ur }} @else {{ old('banner_long_description_ur') }} @endif</textarea>
								</div>
                            </div>
							...
							<div class="form-group ch_field" id="itype" 
								@if($type=="edit") 
									@if($bannerslider->type=="1")
										style="display:block;"
									@else
									...
									@endif
								@endif >
								<label class="col-md-3 control-label" name="description">Banner Photo (Chainise) <br><br> (Note : Banner size minimum 800kb and maximum 2mb)</label>
									<div class="col-md-8">
										<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
													
													@if($bannerslider && $bannerslider->type=="1") <img src="{{asset('assets/images/home_banners')}}/{!! $bannerslider->banner_image_ch !!}" height="190" width="190" /> 
													@endif</div>
													...
													<div>
														<span class="btn btn-default btn-file">
															...
															<span class="fileinput-exists">Change</span>
															@if($bannerslider)
															<input type="file" name="banner_image_ch" id="fileUpload" required></span>
															@else
															<input type="file" name="banner_image_ch" id="fileUpload"></span>
															@endif
														<a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
													</div>
							...
							<div class="form-group hn_field" id="itype" 
								@if($type=="edit") 
									@if($bannerslider->type=="1")
										style="display:block;"
									@else
									...
									@endif
								@endif >
								<label class="col-md-3 control-label" name="description">Banner Photo (Hindi) <br><br> (Note : Banner size minimum 800kb and maximum 2mb)</label>
									<div class="col-md-8">
										<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
													
													@if($bannerslider && $bannerslider->type=="1") <img src="{{asset('assets/images/home_banners')}}/{!! $bannerslider->banner_image_hn !!}" height="190" width="190" /> 
													@endif</div>
													...
													<div>
														<span class="btn btn-default btn-file">
															...
															<span class="fileinput-exists">Change</span>
															@if($bannerslider)
															<input type="file" name="banner_image_hn" id="fileUpload" required></span>
															@else
															<input type="file" name="banner_image_hn" id="fileUpload"></span>
															@endif
														<a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
													</div>
							...
							<div class="form-group ur_field" id="itype" 
								@if($type=="edit") 
									@if($bannerslider->type=="1")
										style="display:block;"
									@else
									...
									@endif
								@endif >
								<label class="col-md-3 control-label" name="description">Banner Photo (Urdu) <br><br> (Note : Banner size minimum 800kb and maximum 2mb)</label>
									<div class="col-md-8">
										<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
													
													@if($bannerslider && $bannerslider->type=="1") <img src="{{asset('assets/images/home_banners')}}/{!! $bannerslider->banner_image_ur !!}" height="190" width="190" /> 
													@endif</div>
													...
													<div>
														<span class="btn btn-default btn-file">
															...
															<span class="fileinput-exists">Change</span>
															@if($bannerslider)
															<input type="file" name="banner_image_ur" id="fileUpload" required></span>
															@else
															<input type="file" name="banner_image_ur" id="fileUpload"></span>
															@endif
														<a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
													</div>
