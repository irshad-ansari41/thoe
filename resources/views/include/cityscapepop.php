...
#cityscape .close {
    position: absolute;
    /* top: 15px; right: 35px; color: #f1f1f1;*/
...
<img id="myImg" src="{{asset('assets/images/about/Cityscape_pop-up-banner.jpg')}}" alt="Cityscape Global 2018" style="display:none;">
...
if(Cityscape === "" || typeof Cityscape ==='undefined' || Cityscape === null){
	setTimeout(function(){$('#myImg').trigger('click');},5000);
