                    ...
                    <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group en_field">
                            ...
                            <div class="col-md-5">
                                ...
                                placeholder="" value="@if($project){{ $project->title }} @endif" />
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group en_field">
                                        ...
                                        <div class="col-md-5">
                                            <textarea id="ckeditor_standard" name="description_en">@if($project){{ $project->description }} @endif</textarea>
                                        </div>

                                        <label class="col-md-1 " name="">Long Description (English)</label>

                                        <div class="col-md-5">
                                            <textarea id="ckeditor_standard" name="description_long_en">@if($project){{ $project->description_long }} @endif</textarea>
                                        </div>
                ...
                function delete_value(id){
                    ...
                    if (r == true) {
                      ...
                      $.ajax({
                        ...
                        { 
                            $('#msgbox').html(data);
                            setTimeout(function(){ $('#msgbox').hide(data)}, 2000); 
