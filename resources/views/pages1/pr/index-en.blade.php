                ...
                <div class="col s12" style="margin-top: 2em;">
                    ...
                    <div id="eventd">
                        ...
                        <div class="row">
                            ...
                            <?php $urllinks = !empty($pres->title) && !empty($pres->description_long) ? url("/$locale/news-pr/{$pres->slug}") : '#' ?>
                                ...
                                <div class="col s12 mt0" style="margin: 1em 0em;">
                                    ...
                                    <div class="desig-person m0">
                                        <div class="person-name mt0" style="font-weight: 900;text-transform: capitalize;    width: 100%;">
                                            <a href="<?= $urllinks ?>" style="text-decoration:none;">  {!! $pres->title !!} </a>
                                        </div>
                                        <i>{{ date("d F Y", strtotime($pres->date)) }}</i>
                                    </div> 
                                    <p class="az-pcontent">
                                        <?= !empty($pres->description_long) ? az_trim_words($pres->description_long) : az_trim_words($pres->description); ?>
                                    </p>
