...
<section class="az-section">
    ...
    <div class="container">
        ...
        <div class="row mb0 mdacntrevntglry">
            ...
            <div class="col s12">
                <p class="az-pcontent" style="text-transform: initial;">
                    ...
                    <div id="eventd">
                        ...
                        <div class="row">
                            <div class="col s12 m4">
                                @if($event->event_photo_en!="")
                                <a href="{{ url('/') }}/{{$locale}}/events/{{ $event->slug_en }}">
                                    <img alt="{{ trim($event->event_photo_alt) }}"  src="{{ asset('assets/images/events/') }}/{{ $event->event_photo_en }}" class="responsive-img">
                                </a>
                                @else
                                <a href="{{$locale}}/events/{{ $event->slug_en }}"><img alt="{{ trim($event->event_photo_alt) }}"  src="{{ asset('assets/images/events/') }}/aziziaura.jpg" class="responsive-img">	</a>
                                @endif
                            ...
                            <div class='col s12 m8'>
                                <div class="col s12 mt0" style="padding: 0em 3em;margin: 1em 0em;">
                                    ...
                                    <div class="desig-person m0">
                                        <a href="{{ url('/') }}/{{$locale}}/events/{{ $event->slug_en }}">
                                            <div class="person-name mt0" style="font-weight: 900;text-transform: unset;">
                                                <?= $event->event_title_en ?>
                                            </div>
                                            <?php
                                            ...
                                            ?>   
                                            <i><?php echo $cuday.$Lsday.' '.$MYear;?></i>
                                        </a>
                                    </div>
                                    ...
                                    <a href="{{ url('/') }}/{{$locale}}/events/{{ $event->slug_en }}" style="font-size: 12px;text-decoration: underline;color: grey; font-weight: bold;">
                                    ...
                                    <div class="col s12 p0">
                                        <div class="col s12 m6 p0" style="margin-top: 12px;">
                                            <p class="az-pcontent social-share">
                                                ...
                                                <a href="https://www.facebook.com/dialog/feed?app_id=136745863654131&redirect_uri={{ url('/'.$locale.'/') }}/events/{{ $event->slug_en }}&link={{ url('/'.$locale.'/') }}/events/{{ $event->slug_en }}&picture={{ asset('assets/images/events/') }}/{{ $event->event_photo_en }}&caption={{ $event->event_title_en }}&description={{ $event->event_title_en }}" target="_blank"><i class="ion-social-facebook"></i></a>

                                                <a href="https://twitter.com/share?url={{ url('/'.$locale.'/') }}/events/{{ $event->slug_en }}&via=AZIZI Developments&text={{ $event->event_title_en }}" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Twitter"><i class="ion-social-twitter"></i></a>

                                                <a href="https://www.youtube.com/channel/UCmUtuRMwJxaovjGBNSXx-Jw"  target="_blank"><i class="ion-social-youtube"></i></a>

                                                <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?=SITE_URL?>/&title={{ $event->event_title_en }}&summary={{date("d F Y", strtotime( $event->event_date)) }}&source=LinkedIn" target="_blank"><i class="ion-social-linkedin"></i></a>
                        ...
                        $schema_tag .= '<script type="application/ld+json">
                                                        {
                                                          ...
                                                          "description": "' . $event->extra_desc_en . '",
                                                          "image": "' . url('/') . "/assets/images/events/" . $event->event_photo_en . '",
                                                          ...
                                                          "location": {
                                                                "@type": "Place",
                                                                "name": "' . $event->visit_us_at_en . '",
                                                                "address": {
                                                                  "@type": "PostalAddress",
                                                                  "streetAddress": "' . $event->event_place . '",
