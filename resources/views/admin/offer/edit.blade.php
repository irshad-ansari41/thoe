...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('offer/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <form id="tryitForm" class="form-horizontal" action="<?= URL::to('admin/offer/' . $offer->id . '/edit') ?>" method="post" enctype="multipart/form-data">

                <div class="form-group en_field">
                    <label class="col-md-3 control-label "> Title(English) </label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="title_en" placeholder="" value="<?= !empty($offer) ? $offer->title_en : old('title_en') ?>" />
                    </div>
                </div>
                <div class="form-group ar_field">
                    <label class="col-md-3 control-label "> Title(Arabic) </label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="title_ar" placeholder="" value="<?= !empty($offer) ? $offer->title_ar : old('title_ar') ?>" />
                    </div>
                </div>
                ...
                <div class="form-group en_field">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control textarea" name="description_en" rows="4"><?= !empty($offer) ? $offer->description_en : old('description_en') ?></textarea>
                    </div>
                </div>
                <div class="form-group ar_field">
                    <label class="col-md-3 control-label ">Description(Arabic) </label>
                    <div class="col-md-8">
                        <textarea class="form-control textarea" name="description_ar" rows="4"><?= !empty($offer) ? $offer->description_ar : old('description_ar') ?></textarea>
                    </div>
                </div>
...
<script type="text/javascript" src="{{ asset('assets/js/pages/add_newoffer.js') }}" ></script>
@stop