...
<section class="az-section">
    <div id="hero-image-cont" class="container only-heading">
        <div style="position: relative;">
            @if($about->banner_image!="")
            <img class="hero-image" alt="<?= $about->banner_image_alt ?>" src="<?= asset('assets/images/about/') ?>/<?= $about->banner_image ?>" style="width: 100%;">
            @endif
            <div class="center-align card tag-pro">
