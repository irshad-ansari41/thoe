...
<html lang="en" >
    ...
    <body class="home-page homepage-sbg ">
        <div style="max-width:1200px;margin:20px auto">
            <a href="https://cloudme02.infosalons.biz/reg/CSGLOBAL18DU/Visitor" target="_blank">
                <img src="<?=SITE_URL?>/assets/images/Cityscape-Customers.jpg" alt="" style="width:100%" />
            </a>
        </div>
    </body>
</html>