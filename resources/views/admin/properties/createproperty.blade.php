                    ...
                    <div class="panel-body">
						...
						<div class="form-group striped-col">
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Property Name (Chinese)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control"  name="title_ch" value="@if($properties){{ $properties->title_ch }} @endif"
                                           placeholder="Enter property name" />
                                </div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Property Name (Hindi)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control"  name="title_hn" value="@if($properties){{ $properties->title_hn }} @endif" 
                                           placeholder="Enter property name" />
                                </div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Property Name (Urdu)</label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control"  name="title_ur"
                                        value="@if($properties){{ $properties->title_ur }} @endif" placeholder="Enter property name" />
                                </div>
                            </div>
							...
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="short_description_ch" rows="4">@if($properties){{ $properties->short_description_ch }} @else {{ old('short_description_ch') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="short_description_hn" rows="4">@if($properties){{ $properties->short_description_hn }} @else {{ old('short_description_hn') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
                                   <textarea class="form-control" name="short_description_ur" rows="4">@if($properties){{ $properties->short_description_ur }} @else {{ old('short_description_ur') }} @endif</textarea>
                                </div>
                            </div>
							...
							<div class="form-group ar_field">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="long_description_ar">@if($properties){{ $properties->long_description_ar }} @endif</textarea>
								</div>
                            </div>
							<div class="form-group ch_field">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="long_description_ch">@if($properties){{ $properties->long_description_ch }} @endif</textarea>
								</div>
                            </div>
							...
							<div class="form-group hn_field">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="long_description_hn">@if($properties){{ $properties->long_description_hn }} @endif</textarea>
								</div>
                            </div>
							...
							<div class="form-group ur_field">
                                ...
                                <div class="col-md-8">
									<textarea id="ckeditor_standard" name="long_description_ur">@if($properties){{ $properties->long_description_ur }} @endif</textarea>
								</div>
                            </div>
							...
							<div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Building Height (Chinese)</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="building_height_ch" value="@if($properties){{ $properties->building_height_ch }} @endif"
                                           placeholder="Enter building height"  />
                                </div>
                            </div>
							
							<div class="form-group hn_field">
                                <label class="col-md-3 control-label hidden-xs">Building Height (Hindi)</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="building_height_hn" value="@if($properties){{ $properties->building_height_hn }} @endif"
                                           placeholder="Enter building height"  />
                                </div>
                            </div>
							
							<div class="form-group ur_field">
                                <label class="col-md-3 control-label hidden-xs">Building Height (Urdu)</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="building_height_ur" value="@if($properties){{ $properties->building_height_ur }} @endif"
                                           placeholder="Enter building height"  />
                                </div>
                            </div>
