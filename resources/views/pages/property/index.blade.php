...
<style>
    ...
    @media screen and (min-width:900px){
        ...
        .Fbtn-Ar{position:absolute; left: 100px; font-weight: bold; margin-top:-3px; font-size: 26px !important;}
    }
    @media screen and (max-width:899px){
        .az-p{color: #fff; font-size:1.1em !important; word-spacing: -1px; }
        .Fbtn{position:absolute; right: 30px; font-weight: bold; margin-top:-3px; font-size: 26px !important;}
        .Fbtn-Ar{position:absolute; left: 30px; font-weight: bold; margin-top:-3px; font-size: 26px !important;}
    }
...
<section class="az-section">
    ...
    <?php if($agent->isDesktop() && in_array($locale, ['en','ar'])):?>
    <div class="row">
        
        <div class="col s12 near-by p0">
            <div class="col s12 m12" style="padding-top: 2rem;">
                <h5 class="mb0" style="padding-bottom: 30px; margin-top: 0;">Top reasons to invest in property in Dubai</h5>
                                ...
                                <?php foreach ($Community as $near) { ?>
                                    <?php if ($i == 1) { ?>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <br/>
                                            <div style="color:#fff; ">
                                                {!! showTextByLocale($locale,[$near->description_en,$near->description_ar,$near->title_ch]) !!}
    ...
    <?php if($agent->isMobile() && in_array($locale, ['en','ar'])):?>
        ...
        <ul class="collapsible">
            ...
            <li class=""active>
                <div class="collapsible-header">
                    ...
                    <i class="material-icons Fbtn<?=!empty(in_array($locale, ['en','cn'])) ?'':'-Ar' ?>">keyboard_arrow_down</i>
                </div>
                <div class="collapsible-body" style="background:linear-gradient( rgba(21,88,149,0.5),  rgba(21,88,149,0.5) ), url('{{asset('assets/images/near')}}/{{ $rows->image }}'); width: 100%; padding:0px 10px;">
                    ...
                    {!! showTextByLocale($locale,[$rows->description_en,$rows->description_ar,$rows->title_ch]) !!}
