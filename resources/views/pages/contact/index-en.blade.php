...
<section class="az-section">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <!-- Form -->
                <form method="post" action="<?= url($locale . '/contact-send') ?>" name="contact" id="contact">
                    <div class="card">
                        <div class="row m0">
                            ...
                            <div class="col s12 m3 form-group">
                                <input type="email" class="autocomplete form-control" placeholder="{{trans('words.email_label')}}" name="email" id="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" >
                            </div>
                            <div class="col s12 m3 form-group">
                        ...
                        <div class="row m0">
                            ...
                            <div class="col s12 m12 form-group">
                                ...
                                <input type="hidden" class="form-control lead_campaign"  name="campaign" value="Contact Us">
...
<script type="text/javascript">
            ...
            if (campaign !== '' && campaign !== null) {
                ...
                sessionStorage.setItem("utm_campaign", 'Contact Us');
            }
