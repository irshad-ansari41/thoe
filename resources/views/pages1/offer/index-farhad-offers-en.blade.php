...
<section>
    <div class="parallax-container valign-wrapper only-heading" style="background-image:url('<?= SITE_URL ?>/emailer/creek-views/Azizi-offer-slider-image-7.jpg');">
        ...
        <div class="col s12 center-align card tag-pro">
            <h1 style="text-align:center;">COME AND DISCOVER</h1>
    ...
    <div class="container" style="width:100%;">
        <div class="row">
            ...
            <div class="col s12 m12 pro-holder center-align Completed mobileds-1">
                ...
                <h6 style="padding-bottom:20px;color:#fff;font-size: 18px !important;padding: 20px;">THE EPICENTRE OF THE FUTURE, IN DUBAI HEALTHCARE CITY. REPRESENTING THE TRANSITION FROM OLD TO NEW, THIS EXCEPTIONAL DEVELOPMENT EMBODIES MODERN LUXURY AT ITS FINEST.</h6>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 pro-holder center-align Completed mobileds">
                <!--h1 class="span2"><b></b></h1-->
                <h6 style="padding-bottom:20px;">THE EPICENTRE OF THE FUTURE, IN DUBAI HEALTHCARE CITY. REPRESENTING THE TRANSITION FROM OLD TO NEW, THIS EXCEPTIONAL DEVELOPMENT EMBODIES MODERN LUXURY AT ITS FINEST.</h6>
            ...
            <div class="col s12 m12 pro-holder center-align Completed">
                <iframe src="https://www.youtube.com/embed/QM9CEsaMtwQ?rel=0" frameborder="0" allowfullscreen style="width: 100%;height: 460px;"></iframe>
            </div>

            <div class="col s12 m4 pro-holder center-align Completed">

                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1a.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1a.jpg" class="responsive-img pro-image"/>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1b.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1b.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>40/60 Payment Plan</h5>                       
                    </div>
                </div>
            </div>
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-2.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-2.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>50% Post Completion</h5>                       
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-3.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-3.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>Studio</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-4.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-4.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>1 & 2 Bedrooms</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-5.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-5.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>Rapid Construction progress</h5>                       
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m8 pro-holder center-align Completed">
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/Creek-Views-Single-3.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/Creek-Views-Single-3.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>Construction Completed</h5>                       
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Azizi" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-6.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-6.jpg" class="responsive-img pro-image" style="height: 437px;"/>
                    <div class="col s12 title-holder">
                        <h5>Get Your Views Now</h5>                       
                    </div>
                </div>
            </div>
...
<script>
    ...
    sessionStorage.setItem("ips_offers_url", '<?= SITE_URL ?>/en/creek-views');
</script>             
