                    ...
                    <div class="panel-body">
                        <form id="tryitForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Address Title(Chinese) </label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="address_title_ch"
                                           placeholder="" value="@if($contacts){{ $contacts->address_title_ch }} @endif" />
                                </div>
                            </div>
                            ...
                            </div><div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Address(Chinese) </label>

                                <div class="col-md-8">
									<textarea class="form-control" name="address_ch" rows="4">@if($contacts){{ $contacts->address_ch }} @else {{ old('address_ch') }} @endif</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group ch_field">
                                <label class="col-md-3 control-label hidden-xs">Working Hours(Chinese) </label>

                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="working_hours_ch"
                                           placeholder="" value="@if($contacts){{ $contacts->working_hours_ch }} @endif" />
                                </div>
                            </div>
