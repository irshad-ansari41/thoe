...
<section>
    <div class="parallax-container valign-wrapper only-heading" style="background-image:url('<?= SITE_URL ?>/emailer/creek-views/Thoe-offer-slider-image-7.jpg');">
        ...
        <div class="row">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1a.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1a.jpg" class="responsive-img pro-image"/>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1b.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-1b.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-2.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-2.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-3.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-3.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>Studio</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-4.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-4.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
                        <h5>1 & 2 Bedrooms</h5>                       
                    </div>
                </div>
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-5.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-5.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m8 pro-holder center-align Completed">
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/Creek-Views-Single-3.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/Creek-Views-Single-3.jpg" class="responsive-img pro-image"/>
                    <div class="col s12 title-holder">
            ...
            <div class="col s12 m4 pro-holder center-align Completed">
                ...
                <div class="card col s12 p0 cards">
                    <img alt="Creek Views By Thoe" src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-6.jpg" data-src="<?= SITE_URL ?>/emailer/creek-views/CreekViews-Carousel-6.jpg" class="responsive-img pro-image" style="height: 437px;"/>
                    <div class="col s12 title-holder">
