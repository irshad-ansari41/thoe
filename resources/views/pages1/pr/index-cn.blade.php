    ...
    <div class="container">
        ...
        <div class="row m0">
            <div class="col s12 p0">
                <div class="col s12 p0">
                    <?= generate_breadcrumb([url("$locale") => trans('words.home'), url("/$locale/media-center") => trans('words.Media centre'), '' => $content->title_ch]) ?>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div id="eventd">
                        ...
                        <div class="row">
                            <div class="col s12 m4">
                                <a href="<?= url("/$locale/news-pr/{$pres->slug}") ?>" style="text-decoration:none;"> 
                                ...
                                <div class="col s12 mt0" style="margin: 1em 0em;">
                                    <div class="desig-person m0">
                                        ...
                                        <div class="person-name mt0" style="font-weight: 900;text-transform: capitalize;    width: 90%;">
                                            <a href="<?= url("/$locale/news-pr/{$pres->slug}") ?>" style="text-decoration:none;"> {!! $pres->title_ch!!}</a>
                                        </div>
                                        <i>
                                            <?php
                                    ...
                                    <p class="az-pcontent">
                                        <?= !empty($pres->description_long_ch) ? az_trim_words($pres->description_long_ch): az_trim_words($pres->description_ch); ?>                                      
                                    </p>
                                    <a href="<?= url("/$locale/news-pr/{$pres->slug}") ?>" style="font-size:12px;text-decoration:underline;color:grey;font-weight:bold;"> 
                                    ...
                                    ?>
                                            <a href="{!! $doc_url !!}" style="margin-right: 5em;font-size: 12px;" download>
